...
9. Разногласия по поводу критических замечаний, если не удалось договориться в личной беседе, решаются на командном синке/опросе. Здесь нет преимущества у автора PR или ревьюера.
10. “Я исправлю это потом” - принимается только в том случае, если есть задача в Kaiten, которая и является этим “потом“. Если такой задачи в Kaiten нет - надо исправлять в текущем PR. Можно попросить тимлида создать такую задачу.
